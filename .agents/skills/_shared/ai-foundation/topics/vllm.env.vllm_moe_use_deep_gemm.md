---
topic_id: vllm.env.vllm_moe_use_deep_gemm
canonical_term: VLLM_MOE_USE_DEEP_GEMM
...
- aliases: `VLLM_MOE_USE_DEEP_GEMM`, `vllm_moe_use_deep_gemm`, `vllm-moe-use-deep-gemm`, `vllm moe use deep gemm`, `expert_parallel`, `expert parallel`, `expert-parallel`
...
- definition_ref: vllm/envs.py:1134
- read_ref: vllm/vllm/envs.py:150, vllm/vllm/envs.py:1134, vllm/vllm/envs.py:1135
