...
| `--api-server-count` | `network_serving` | `upstream_delta` | `0.75` | vllm/entrypoints/openai/cli_args.py:293 | 6 |
...
| `--config` | `general_runtime` | `upstream_delta` | `0.68` | vllm/entrypoints/openai/cli_args.py:301 | 3 |
...
| `--headless` | `general_runtime` | `upstream_delta` | `0.75` | vllm/entrypoints/openai/cli_args.py:286 | 6 |
