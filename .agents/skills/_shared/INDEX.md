...
| "这个参数/环境变量是干什么的" | [global parameter feature map](deployment-config/references/global-parameter-feature-map.md) | [global combination guide](deployment-config/references/global-parameter-combination-guide.md) | `vllm-ascend-deployment-assistant` |
