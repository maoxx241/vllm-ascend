    ...
    def build(
        ...
        if envs.VLLM_ASCEND_ENABLE_FLASH_MLA:
            ...
            return self.metadata_cls(
                num_actual_tokens=common.num_actual_tokens, num_input_tokens=common.num_input_tokens,
                slot_mapping=common.slot_mapping, query_start_loc=common.query_start_loc,
                seq_lens=common.seq_lens, seq_lens_cpu=None, block_tables=common.block_table_tensor,
                num_decodes=0, num_decode_tokens=0, num_prefills=0,
                causal=common.causal, attn_state=common.attn_state,
        ...
        *,
        ...
        if envs.VLLM_ASCEND_ENABLE_FLASH_MLA:
            ...
            torch_npu.npu_scatter_pa_kv_cache(
                ...
                slot_mapping=slots.contiguous(), cache_mode="Norm",
            )
            return k_pe, c_kv
        if not self.use_mla_rope:
