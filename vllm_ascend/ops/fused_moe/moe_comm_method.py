...
class FusedMC2CommImpl(MoECommMethod):
    ...
    def fused_experts(
        ...
        # Kimi K3's SiTU activation is implemented by the generic MoE path.
        # Keep other activations on the upstream MegaMoE path, including
        # unquantized shared experts.
