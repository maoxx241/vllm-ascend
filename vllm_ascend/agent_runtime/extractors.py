    ...
    shard["sources"].extend(
        [
            ...
            (
                ...
                "repo_semantics",
                None,
                json.dumps({"summary": "Supported quantized artifact paths and ModelSlim guidance"}, ensure_ascii=False),
            ),
        ]
    )
    ...
    shard["facts"].extend(
        [
            ...
            (
                ...
                "source-doc-qwen3-dense",
                "repo_semantics",
                json.dumps({"model_base": "qwen3-32b", "model_traits": [], "render_preset": "qwen3_32b_a3_bf16"}, ensure_ascii=False),
            ),
            (
                ...
                "source-doc-qwen3-dense",
                "repo_semantics",
                json.dumps({"model_base": "qwen3-32b", "model_traits": ["quant_w8a8"], "render_preset": "qwen3_32b_a3_w8a8"}, ensure_ascii=False),
            ),
            (
                "fact-qwen3-32b-traits",
                "entity-model-qwen3-32b",
                "model_traits",
                None,
                "Qwen3-32B base deployment profile is dense BF16 by default; W8A8 should be modeled as a trait on top of the same base model.",
                0.91,
                None,
                None,
                json.dumps({"hw": ["A3", "A2"]}, ensure_ascii=False),
                "source-doc-qwen3-dense",
                "repo_semantics",
                json.dumps({"model_base": "qwen3-32b", "model_traits": ["dense", "precision_bf16"]}, ensure_ascii=False),
            ),
            (
                "fact-qwen3-32b-w8a8-traits",
                "entity-model-qwen3-32b-w8a8",
                "model_traits",
                None,
                "Qwen3-32B-W8A8 should reuse the Qwen3-32B base model identity with an added quant_w8a8 trait.",
                0.92,
                None,
                None,
                json.dumps({"hw": ["A3"]}, ensure_ascii=False),
                "source-doc-qwen3-dense",
                "repo_semantics",
                json.dumps({"model_base": "qwen3-32b", "model_traits": ["quant_w8a8"]}, ensure_ascii=False),
            ),
            (
                ...
                "source-doc-deepseek-v3_2",
                "repo_semantics",
                json.dumps({"model_base": "deepseek-v3", "model_traits": ["quant_w8a8", "moe"]}, ensure_ascii=False),
            ),
            (
                "fact-qwen3-32b-a23-native-fp8-unsupported",
                "entity-model-qwen3-32b",
                "runtime_constraint",
                None,
                "Native FP8 weights are not a documented direct deployment path on A2/A3; choose a supported converted artifact path or an adaptation path before emitting deployment commands.",
                0.97,
                None,
                None,
                json.dumps({"hw": ["A2", "A3"]}, ensure_ascii=False),
                "source-doc-quantization-guide",
                "repo_semantics",
                json.dumps({"model_base": "qwen3-32b", "unsupported_input_weight": "fp8_native"}, ensure_ascii=False),
            ),
            (
                "fact-qwen3-32b-modelslim-tool-recipe",
                "entity-model-qwen3-32b",
                "tool_recipe",
                None,
                "ModelSlim is the documented Ascend-friendly conversion tool for supported quantized artifacts. Converted weights can then be served with --quantization ascend.",
                0.9,
                None,
                None,
                json.dumps({"hw": ["A2", "A3"]}, ensure_ascii=False),
                ...
                json.dumps(
                    {
                        "model_base": "qwen3-32b",
                        "tool_name": "ModelSlim",
                        "artifact_path_kind": "convert_then_deploy",
                        "supported_traits": ["quant_w8a8", "quant_w4a8", "quant_w4a4"],
                    },
                    ensure_ascii=False,
                ),
            ),
            (
                "fact-a3-local-comm-profile",
                "entity-hw-a3",
                "communication_profile",
                None,
                "On A3, any TP/DP/EP strategy spanning more than one logical NPU requires local communication setup even inside a single physical card.",
                0.95,
                None,
                None,
                json.dumps({"hw": ["A3"], "min_logical_npus": 2}, ensure_ascii=False),
                "source-repo-cpu-binding",
                "repo_semantics",
                json.dumps({"hw": ["A3"], "comm_profile": "local_multi_logical_npu", "env_profile": "local_tp_env"}, ensure_ascii=False),
            ),
        ]
    )
    shard["edges"].extend(
    ...
    shard["validations"].extend(
        [
                ...
                json.dumps(
                    {
                        ...
                        "data_parallel": 1,
                        "expert_parallel": 1,
                        "render_preset": "qwen3_32b_a3_bf16",
                    },
                    ensure_ascii=False,
                ),
            ),
                ...
                json.dumps(
                    {
                        ...
                        "data_parallel": 1,
                        "expert_parallel": 1,
                        "render_preset": "qwen3_32b_a3_w8a8",
                    },
                    ensure_ascii=False,
                ),
            ),
            (
                ...
                json.dumps(
                    {
                        "model_base": "deepseek-v3",
                        "model_traits": ["quant_w8a8", "moe"],
                        "hw": "A3",
                        "render_preset": "deepseek_v3_a3_single_node_w8a8",
                    },
                    ensure_ascii=False,
                ),
            ),
