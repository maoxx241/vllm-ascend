...
class KimiK3ProcessorKwargs(ProcessingKwargs, total=False):  # type: ignore[call-arg]
    _defaults = {}
...
class KimiK3Processor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[KimiK3ProcessorKwargs],
    ) -> BatchFeature:
        output_kwargs = self._merge_kwargs(
            KimiK3ProcessorKwargs,
        ...
        return BatchFeature(data={**text_inputs, **mm_inputs})
