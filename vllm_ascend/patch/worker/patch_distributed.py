...
def _wrap_destroy_distributed_environment(destroy_fn):
    if getattr(destroy_fn, "_hccl_registry_clearing_wrapped", False) is True:
        return destroy_fn
    ...
    wrapped._hccl_registry_clearing_wrapped = True
    return wrapped


def _patch_destroy_distributed_environment():
    destroy_fn = _wrap_destroy_distributed_environment(
    ...
    def __init__(
        ...
        try:
            ...
            try:
                ...
                logger.exception(
                    "Failed to clean up partially initialized GroupCoordinatorPatch"
                )
            raise
