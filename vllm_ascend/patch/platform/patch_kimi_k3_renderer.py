    ...
    def _apply_chat_template(
        ...
        **kwargs: Any,
        ...
        if prompt_tool_choice is not None:
            # ChatParams treats the literal string ``auto`` as an unset value
...
# Prepare K3-only controls at the shared online-renderer entry used by both
# OpenAI serving and the standalone render API.
