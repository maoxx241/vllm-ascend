...
class AscendKimiDecoderLayer(UpstreamKimiDecoderLayer):
    ...
    def forward_attn_residual(
        ...
        if prepared_attn_input is None:
            prepared_attn_input = self.prepare_attn_residual(hidden_states, block_residual)
        ...
        hidden_states, prefix_sum, _ = torch.ops._C_ascend.attn_res_fwd.fused(
        ...
        hidden_states, _, _ = torch.ops._C_ascend.attn_res_fwd.fused(
            prefix_sum,
            mlp_output,
            block_residual,
            self.mlp_res_proj.weight,
